...
const ConsultantFinancials = () => {
  ...
  const [consultantFinancial, setConsultantFinancial] = useState<ConsultantFinancialType[]>([])
  ...
  const handleChange = (event: React.ChangeEvent<unknown>, value: number) => {
    ...
    fetchMore({
      variables: {
        first: process.env.REACT_APP_USERS_PER_PAGE ? parseInt(process.env.REACT_APP_USERS_PER_PAGE) : 5,
        page: value,
        orderBy: [
          {
            column: orderBy,
    ...
    <Container maxWidth="xl" sx={{ mt: 4, mb: 4 }}>
      ...
      <TableContainer component={Paper}>
        <Table aria-label="customized table">
          ...
          <TableBody>
            {consultantFinancial.map((element: ConsultantFinancialType, index: number) => (
              <StyledTableRow key={element.id}>
                ...
                <StyledTableCell align="center">
                  ...
                  <Typography component={'div'} sx={{ fontSize: 9, fontWeight: 'bold' }}>
                    {element.user ? element.user?.first_name + ' ' + element.user?.last_name : null}
                  </Typography>
                </StyledTableCell>
                <StyledTableCell align="center">
                ...
                <StyledTableCell align="left">{moment(element.created_at).format('jYYYY/jMM/jDD')}</StyledTableCell>
                <StyledTableCell align="left">
                  <Button
                    size="small"
                    onClick={() => {
