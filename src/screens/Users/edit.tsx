...
const UersEditScreen = () => {
  ...
  return (
    <Container maxWidth="xl" sx={{ mt: 4, mb: 4 }}>
      ...
      <Box mt={2}>
        <Button variant="contained" startIcon={<SaveIcon />} color="primary" onClick={editUserHandler}>
          ثبت تغییرات
        </Button>
        <Button sx={{ float: 'right' }} variant="contained" color="secondary" onClick={() => navigate(`/users`)}>
          <ArrowBackIcon />
          بازگشت
        </Button>
      </Box>
